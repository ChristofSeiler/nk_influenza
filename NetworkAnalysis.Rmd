...
```{r}
interaction_table = as.data.frame(get.edgelist(module))
names(interaction_table) = c("proteinA","proteinB")
interaction_table = data.frame(interaction_table,score=1-fdr)
```
